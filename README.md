...
For more details please refer to plugin documentation (wiki, discord). Module only gets the reports generated by the plugin and stores/displays them.
